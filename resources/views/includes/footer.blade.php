...
<!-- Footer -->
<footer class="bg-dark navbar-dark text-white py-4">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h5>Contacto</h5>
                <p>academic_central<br>
                Dirección: [popayan]<br>
                Teléfono: [3114143921]<br>
                Correo electrónico: [academic_central@gmail.com]</p>
            </div>
            <div class="col-md-6">
                <h5>Síguenos</h5>
        ...
        <hr>
        <p class="text-center">&copy; {{ date('Y') }} Academi. Todos los derechos reservados.</p>
    </div>
</footer>