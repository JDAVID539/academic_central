...
<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="dark" data-background-color="dark" data-image="../assets/img/sidebar-1.jpg">
      ...
      <div class="logo">
        <a href="{{route('vist_superadministrador')}}" class="simple-text logo-mini">
          AC
        </a>
        <a href="{{route('vist_superadministrador')}}" class="simple-text logo-normal">
          academic_central
        </a>
      </div>
      <div class="sidebar-wrapper" id="sidebar-wrapper">
        <ul class="nav">
          <li class="desative ">
            <a href="{{route('vist_superadministrador')}}">
              <i class="now-ui-icons design_app"></i>
              <p>inicio</p>
            </a>
          </li>
          <li>
           <a href="{{route('listado.colegios')}}">
...
<li>
    ...
    <div class="main-panel" id="main-panel">
      <!-- Navbar -->
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #343434;">
...
<li class="nav-item">
              <a class="nav-link text-white" href="#">
                ...
                <p class="d-none d-lg-block">
                  ...
                  @if (session('user_type') === 'school')
                    {{ session('school_name') }}
                  @elseif (session('user_type') === 'super_administrador')
                    {{ session('super_administrador_name') }}
                  @elseif (Auth::check())
                    {{ Auth::user()->name }}
                  @else
                    Invitado
