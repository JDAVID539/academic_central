...
<div class="container mt-4">
  <div class="card mx-auto" style="max-width: 600px;">
    <div class="card-body text-center">
      @if($school)
        <h4 class="mb-3">{{ $school->name_school ?? 'Nombre de la Institución no disponible' }}</h4>
      @endif
      @if($profile && $profile->foto)
        <img src="{{ asset('uploads/' . $profile->foto) }}" alt="Foto del Profesor" class="rounded-circle mb-3" style="width: 150px; height: 150px; object-fit: cover;">
      @else
      ...
      <a href="{{ route('teacher.profile.edit') }}" class="btn btn-primary mt-3">
